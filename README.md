...
**Ticket execution orchestrator for Claude Code.** Plugin version 6.6.0.
...
**Current version: 6.6.0.** All migrations are idempotent and run automatically the next time any in-flight ticket is touched. See [`CHANGELOG.md`](./CHANGELOG.md) for per-version detail.
